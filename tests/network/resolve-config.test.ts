...
test('resolveNetworkConfig applies DEFAULT_NETWORK_CONFIG when network block absent', () => {
...
test('resolveNetworkConfig merges domain JSON5 service.network with CLI overrides', () => {
...
test('resolveNetworkConfig uses ops.watch.debounceMs when network debounceMs unset', () => {
	const domainConfig = {
...
test('resolveNetworkConfig honors distPathOverride for supply-chain --path', () => {
	const resolved = resolveNetworkConfig({
		domain,
		projectRoot,
