...
export const DOMAIN_FIELD_MATRIX: readonly DomainFieldRow[] = [
	...
	},
	{
		...
		section: 'audit',
		flags: {template: true, domain: true, branding: false, service: true, secrets: false},
		description: 'Encrypted audit SQLite path',
		bunApi: 'bun:sqlite',
	},
	{
		...
		section: 'audit',
		flags: {template: true, domain: true, branding: false, service: true, secrets: false},
		description: 'Audit encryption key (or AUDIT_MASTER_KEY)',
	},
	{
		field: 'audit.sqlite.compress',
		section: 'audit',
		flags: {template: true, domain: true, branding: false, service: true, secrets: false},
		description: 'Compress encrypted audit payloads',
	},
	{
		field: 'audit.sqlite.compressionFormat',
		section: 'audit',
		flags: {template: true, domain: true, branding: false, service: true, secrets: false},
		description: 'gzip or zstd compression',
	},
	{
